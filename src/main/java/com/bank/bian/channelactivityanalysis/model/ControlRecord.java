package com.bank.bian.channelactivityanalysis.model;
...
/**
 * The BIAN control record for this service domain: "Channel Activity Model Analysis".
 *
 ...
 * to its asset type (Channel Activity Model). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Channel Activity Model Analysis";
